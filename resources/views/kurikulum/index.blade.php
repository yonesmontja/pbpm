...
@section('title')
  <title> AdminLTE 3 | Kurikulum </title>
@endsection
...
<div class="content-wrapper" styel="min-height: 454px;">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Kurikulum</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
                ...
                <div class="row">
                  <div class="col-md-8">
                    ...
                    <div class="chart"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      <!-- Sales Chart Canvas -->
                      <canvas id="salesChart" height="180" style="height: 180px; display: block; width: 1044px;" width="1044" class="chartjs-render-monitor"></canvas>
                    </div>
                    <!-- /.chart-responsive -->
                  </div>
                  <!-- /.col -->
              ...
              <div class="card-body p-0">
                <div class="d-md-flex">
                  <div class="p-1 flex-fill" style="overflow: hidden">
                    ...
                    <div id="world-map-markers" style="height: 660px; overflow: hidden" class="mapael">
                      <div class="map">
                        <svg height="2400" version="1.1" width="2400" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="overflow: hidden; position: relative; top: -0.5px;" viewBox="0 0 959 593" preserveAspectRatio="xMinYMin">
                          <desc style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
                            Created with Raphaël 2.3.0 and Mapael undefined (https://www.vincentbroute.fr/mapael/)
                          </desc>
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="chart-responsive"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      <canvas id="pieChart" height="159" width="318" class="chartjs-render-monitor" style="display: block; width: 318px; height: 159px;"></canvas>
                    </div>
                    <!-- ./chart-responsive -->
                  </div>
                  <!-- /.col -->
