          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <p class="text-muted text-center">{{$visi_profile->visi}}</p>
                <p class="text-muted text-center">{{$visi_profile->visi_deskripsi}}</p>
                <p class="text-muted text-center">{{$visi_profile->visi_notes}}</p>
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#misi" data-toggle="tab">MISI</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="misi">
                    ...
                    <div class="post">
                      <div class="row">
                        <div class="col-md-9">
                          <div class="user-block">
                            ...
                            <span class="username">
                              <a href="#">{{$visi_profile->visi}}</a>
                            </span>
                            <span class="description">Periode: {{$visi_profile->visi_start}} - {{$visi_profile->visi_end}}</span>
                          </div>
                        </div>
                        <div class="col-md-3">
                      ...
                      <!-- /.user-block -->
                      @foreach($visi_profile->misi as $ms)
                      <p>Pernyataan misi: {{$ms->id}} - {{$ms->misi_deskripsi}}</p>
                      <p>Catatan: {{$ms->id}} - {{$ms->misi_notes}}</p>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!-- form isian data -->
        <form action="/visi/{{$visi_profile -> id}}/visimisiadd" method="POST" enctype="multipart/form-data">
          {{csrf_field()}}
          <div class="form-group">
            <label for="misi_deskripsi">Misi</label>
            <select class="form-control" id="misi_deskripsi" name="misi_deskripsi">
              @foreach ($misio as $ms)
              <option value="{{$ms -> id}}">{{$ms->misi_deskripsi}}</option>
              @endforeach
            </select>
          </div>
          <div class="form-group">
            <label for="misi_notes">Catatan misi</label>
            <select class="form-control" id="misi_notes" name="misi_notes">
              @foreach ($misio as $ms)
              <option value="{{$ms -> id}}">{{$ms->misi_notes}}</option>
              @endforeach
            </select>
          </div>
          <div class="row">
