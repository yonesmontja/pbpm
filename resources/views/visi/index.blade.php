                                    ...
                                    <tbody>
                                        @foreach ($data_visi as $visi)
                                            <tr>
                                                ...
                                                <td><a href="/visi/{{ $visi->id }}/visiprofile">{{ $visi->visi }}</a>
                                                </td>
                                                <td>{{ $visi->visi_deskripsi }}</td>
                                                <td>{{ $visi->visi_notes }}</td>
                                                <td>
                                                    <a href="/visi/{{ $visi->id }}/visiedit"
                                                    ...
                                                    <a href="/visi/{{ $visi->id }}/visidelete"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- form isian data -->
                                                <form action="/visi/visicreate" method="POST"
                                                    enctype="multipart/form-data">
                                                    {{ csrf_field() }}

                                                    <div
                                                        class="form-group {{ $errors->has('visi_start') ? ' has-error' : '' }}">
                                                        <label for="exampleFormControlInput1">Mulai</label>
                                                        <input name="visi_start" type="text" class="form-control"
                                                            id="exampleFormControlInput1" placeholder="Kapan mulai?"
                                                            value="{{ old('visi_start') }}">
                                                        @if ($errors->has('visi_start'))
                                                            <span
                                                                class="help-block">{{ $errors->first('visi_start') }}</span>
                                                        @endif
                                                    </div>
                                                    @if ($errors->has('visi_start'))
                                                    ...
                                                    <div
                                                        class="form-group {{ $errors->has('visi_end') ? ' has-error' : '' }}">
                                                        <label for="exampleFormControlInput1">Berakhir</label>
                                                        <input name="visi_end" type="text" class="form-control"
                                                            id="exampleFormControlInput1" placeholder="Kapan selesai?"
                                                            value="{{ old('visi_end') }}">
                                                        @if ($errors->has('visi_end'))
                                                            <span
                                                                class="help-block">{{ $errors->first('visi_end') }}</span>
                                                        @endif
                                                    </div>
                                                    @if ($errors->has('visi_end'))
                                                    ...
                                                    <div class="form-group {{ $errors->has('visi') ? ' has-error' : '' }}">
                                                        ...
                                                        <input name="visi" type="text" class="form-control"
                                                            id="exampleFormControlInput1" placeholder="Visi"
                                                            value="{{ old('visi') }}">
                                                        @if ($errors->has('visi'))
                                                    ...
                                                    <div
                                                        class="form-group {{ $errors->has('visi_deskripsi') ? ' has-error' : '' }}">
                                                        <label for="exampleFormControlTextarea1">PERNYATAAN VISI</label>
                                                        <textarea name="visi_deskripsi" class="form-control" id="exampleFormControlTextarea1" placeholder="Pernyataan Visi"
                                                            value="{{ old('visi_deskripsi') }}" rows="3"></textarea>
                                                    </div>
                                                    @if ($errors->has('visi_deskripsi'))
                                                        <span
                                                            class="help-block">{{ $errors->first('visi_deskripsi') }}</span>
                                                    @endif

                                                    <div
                                                        class="form-group {{ $errors->has('visi_notes') ? ' has-error' : '' }}">
                                                        <label for="exampleFormControlTextarea1">NOTES</label>
                                                        <textarea name="visi_notes" class="form-control" id="exampleFormControlTextarea1" placeholder="Catatan"
                                                            value="{{ old('visi_notes') }}" rows="3"></textarea>
                                                    </div>
