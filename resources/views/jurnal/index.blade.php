        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="/tdu">Jurnal</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Jurnal Pembelajaran</h5>

                <p class="card-text">
                  Jurnal Pembelajaran menjadi bukti otentik proses pengkajian budaya papua dan modernisasi.
                </p>
