        ...
        <div class="col-md-12">
          <div class="card card-outline card-info">
            ...
            <div class="card-body pad">
              <div class="card-body">
                <form action="/jurnalcreate" method="POST" enctype="multipart/form-data" role="form">
                  {{csrf_field()}}
                  <div class="row">
                    <div class="col-sm-8">
                      <!-- text input -->
                      <div class="form-group {{$errors->has('title') ?' has-error' : ''}}">
                        <label>Judul</label>
                        <input name="title" type="text" class="form-control" placeholder="Masukkan judul" value="{{old('title')}}">
                        @if($errors->has('title'))
