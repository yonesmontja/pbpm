                                                ...
                                                <form action="/siswa/create" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="nama_depan" type="text" class="form-control"
                                                            id="exampleFormControlInput1" placeholder="Masukkan nama depan"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="nama_belakang" type="text" class="form-control"
                                                            id="exampleFormControlInput2" placeholder="nama belakang">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                                                        ...
                                                        <input name="email" type="email" class="form-control"
                                                            id="formGroupExampleInput3" placeholder="Masukkan Email"
                                                            value="{{ old('email') }}">
                                                        @if ($errors->has('email'))
                                                            <span
