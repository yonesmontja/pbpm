                                            ...
                                            foreach ($tampung as $siswa) {
                                                ...
                                                foreach ($siswa->rombel as $r) {
                                                    ...
                                                    foreach ($siswa->nilai as $n) {
                                                        if ($r->tahunpelajaran_id == $thn_id && $n->tahunpel_id == $thn_id) {
                                                            if ($n->penilaian_id == 3 && $n->rombel_id == $r->id) {
                                                                $ph[] = [
                                                                    'nilai' => $n->nilai,
                                                                ];
                                                            }
                                        ...
                                        @if (auth()->user()->role == 'admin' || auth()->user()->role == 'tata_usaha')
                                            @foreach ($tampung as $data)
                                                <tr>
                                                    ...
                                                    <td>{{ $data->agama }}</td>
                                                    @foreach ($data->rombel as $ds)
                                                        @if ($ds->tahunpelajaran_id == $thn_id)
                                                            <td>{{ $ds->rombel }}</td>
                                                        @endif
                                                    @endforeach
                                                    <td>
                                                        <ul>
                                                            @foreach ($data->nilai as $s)
                                                                @if ($s->tahunpel_id == $thn_id && $s->penilaian_id == 3)
                                                                    <li>{{ $s->nilai }} -
                                                                        {{ $s->mapel->nama_mapel }}</li>
                                                                @endif
                                                            @endforeach
                                                        </ul>
                                                    </td>
                                                    <td>
                                                        <ul>
                                                            @foreach ($data->nilai as $s)
                                                                @if ($s->tahunpel_id == $thn_id && $s->penilaian_id == 4)
                                                                    <li>{{ $s->nilai }} -
                                                                        {{ $s->mapel->nama_mapel }}</li>
                                                                @endif
                                                            @endforeach
                                                    ...
                                                    <td>
                                                        <ul>
                                                            @foreach ($data->nilai as $s)
                                                                @if ($s->tahunpel_id == $thn_id && $s->penilaian_id == 5)
                                                                    <li>{{ $s->nilai }} -
                                                                        {{ $s->mapel->nama_mapel }}</li>
                                                                @endif
                                                            @endforeach
                                                    ...
                                                    <td>
                                                        <ul>
                                                            @foreach ($data->nilai as $s)
                                                                @if ($s->tahunpel_id == $thn_id && $s->penilaian_id == 19)
                                                                    <li>{{ $s->nilai }} -
                                                                        {{ $s->mapel->nama_mapel }}</li>
                                                                @endif
                                                            @endforeach
                                                    ...
                                                    <td>
                                                        <a href="/siswa/{{ $data->id }}/cetak_raport"
                                                    ...
                                                    <td>
                                                        ...
                                                        @endif
                                                        @if ($data->user_id == null && auth()->user()->role == 'admin')
                                                            <a href="/test/{{ $data->id }}/aktivasi"
