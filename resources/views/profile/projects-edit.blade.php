        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Ubah Proyek</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="inputClientCompany">Mitra Pendidik</label>
                <input type="text" id="inputClientCompany" class="form-control" value="Deveint Inc">
              </div>
              <div class="form-group">
                <label for="inputProjectLeader">Ketua Proyek</label>
        ...
        <div class="col-md-6">
          <div class="card card-secondary">
            ...
            <div class="card-body">
              <div class="form-group">
                <label for="inputEstimatedBudget">Perkiraan Anggaran</label>
                <input type="number" id="inputEstimatedBudget" class="form-control" value="2300" step="1">
              </div>
              <div class="form-group">
                <label for="inputSpentBudget">Jumlah dana yang dipakai</label>
                <input type="number" id="inputSpentBudget" class="form-control" value="2000" step="1">
              </div>
              <div class="form-group">
                <label for="inputEstimatedDuration">Perkiraan durasi proyek</label>
