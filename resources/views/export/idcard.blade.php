            ...
            <div class="main">
                ...
                <div class="main-data">
                    <div class="left-div" style="font-size:15px; line-height: 1.5;">
                        <img class="logo" src="{{ public_path('images/logo_dabolding.png') }}" width="210"
                            alt="">
                        <div class="info">
                            <span class="capitalize">{{ $student->nama_depan . ' ' . $student->nama_belakang }}</span><br>
                            <span class="text-md">{{ $student->kelas }}</span><br>
                            <span class="text-md">ID:
                                {{ str_pad($student->id + 1, 4, '0', STR_PAD_LEFT) }}</span><br>
                            <span class="text-md">Batch: {{ $student->tempat_lahir }}</span><br>
                            <span class="text-md">Section: {{ $student->tgl_lahir }}</span><br>
                        </div>
                    </div>
                    <div class="right-div" style="padding-left: 50px">
                        <img style="height: 80px; margin-left:15px;; margin-top:25px;"
                            src="{{ public_path('students/images/' . $student->avatar) }}" alt="" width="75">
            ...
            <div class="main">
                ...
                <div class="main-data">
                    <div style="display: block;" class="back-div">
                        <p class="" style="font-size: 11px; line-height: 50%;">JIKA MENEMUKAN KARTU INI, MOHON DIKEMBALIKAN KE ALAMAT BERIKUT INI.</p>
                        <p class="" style="color: blue; line-height: 40%;">SD INPRES DABOLDING</p>
                        <div style="position:absolute; display: block;">
                            <div style="display: block; margin-bottom: 4px;">
                                ...
                                <div
                                    ...
                                    JL. PAHLAWAN, DABOLDING, KALOMDOL, PEGUNUNGAN BINTANG
                                </div>
                            </div>
                            <div style="display: block; margin-bottom: 4px;">
