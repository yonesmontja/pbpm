          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><a href="#">{{$mapel -> nama_mapel}}</a></h3>

                <p class="text-muted text-center">Semester: {{ $mapel -> semester }}</p>

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Kelompok </b> <a class="float-right">{{$mapel->kelompok}}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Guru </b> <a class="float-right">{{ $mapel->guru->nama_guru }}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Deskripsi singkat </b> <a class="float-right">{{ $mapel -> kd_singkat }}</a>
                  </li>
                </ul>

                <a href="/mapel/{{$mapel->id}}/edit" class="btn btn-primary btn-block"><b>Ubah data mapel</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">{{ $mapel -> is_sikap == '0' ? 'Tidak' : 'Ya' }}</p>
                <hr>
