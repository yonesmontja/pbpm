    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="titleModal">Fast Event</h5>
            ...
            <div class="modal-body">
                ...
                <form id="formFastEvent">
                    <div class="form-group row">
                        <label for="title" class="col-sm-4 col-form-label">Fast Event</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label for="end" class="col-sm-4 col-form-label">Final Time</label>
                        <div class="col-sm-8">
