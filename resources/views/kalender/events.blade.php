    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="titleModal">Event</h5>
            ...
            <div class="modal-body">
                ...
                <form id="formEvent">
                    ...
                    <div class="form-group row">
                        <label for="start" class="col-sm-4 col-form-label">Start Date/Time</label>
                        <div class="col-sm-8">
                            <input type="text" name="start" class="form-control date-time" id="start">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="end" class="col-sm-4 col-form-label">Final Date/Time</label>
                        <div class="col-sm-8">
