...
<head>
	...
	<!-- VENDOR CSS -->
	<link rel="stylesheet" href="{{asset('/adminklo/css/bootstrap.min.css')}}">
	...
	<!-- ICONS -->
	<link rel="apple-touch-icon" sizes="76x76" href="{{asset('/adminklo/img/apple-icon.png')}}">
			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{asset('/adminklo/img/logo-dark.png')}}" alt="Klorofil Logo"></div>
