                         ...
                         <div class="card card-primary card-outline">
                             <div class="card-body box-profile">
                                 <div class="text-center">
                                     <img class="profile-user-img img-fluid img-circle" src="{{ $level->avatar() }}"
                                         alt="User profile picture">
                                 </div>

                                 <h3 class="profile-username text-center"><a href="#">{{ $level->level }} </a></h3>

                                 <p class="text-muted text-center">Level</p>

                                 <ul class="list-group list-group-unbordered mb-3">
                                     <li class="list-group-item">
                                         <b>Level</b> <a class="float-right">{{ $level->count() }}</a>
                                     </li>
                                     <li class="list-group-item">
