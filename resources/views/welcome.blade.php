    ...
    <div class="container">
      <div class="row justify-content-between">
        ...
        <div class="col-lg-4 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
          <img src="{{ asset('/frontend2/assets/img/hero-img.png') }}" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
            <h3>Visi Sekolah</h3>
            <p>Menghasilkan generasi yang beriman, menguasai ilmu pengetahuan dan teknologi, berbudaya, peduli dan cinta lingkungan</p>
        ...
        <div class="row" data-aos="fade-up">
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="206" data-purecounter-duration="1" class="purecounter"></span>
              <p>Laki-laki</p>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right">
            <img src="{{ asset('/frontend2/assets/img/details-5.jpg') }}" class="img-fluid" alt="">
          </div>
          <div class="col-md-8 pt-4" data-aos="fade-up">
            ...
            <ul>
              ...
              <li><i class="bi bi-check"></i> Siswa mengembangkan setiap temuan menjadi Imajinasi dan Pemaknaan.</li>
              <li><i class="bi bi-check"></i> Siswa menguasai fungsi-fungsi penting dalam rumah Bokam.</li>
            </ul>
            <p>
              Dalam proses ini, guru menjadi fasilitator bagi siswa untuk belajar. Guru menjadi penilai hasil karya siswa</p>
          </div>
        </div>

        <div class="row content">
          <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
            <img src="{{ asset('/frontend2/assets/img/details-6.jpg') }}" class="img-fluid" alt="">
          </div>
          <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
            <h3>Siswa belajar dengan bahan-bahan yang ada di alam lingkungan sekitar kampung</h3>
            <p class="fst-italic">
              Pembelajaran berbasis budaya, menggunakan modal-modal budaya dan mengembangkannya melalui pembelajaran kontekstual.
            </p>
            <p>
              Bahan-bahan, seperti rotan, kayu bulat, mudah ditemukan di dusun-dusun atau hutan di sekitar kampung tempat tinggal siswa.
            </p>
            <p>
              Penilaian proses pembelajaran diarahkan untuk mengukur kemampuan siswa dalam skill yang ada pada fungsi-fungsi budaya lokal masyarakat.
            </p>
          </div>
        </div>
        ...
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right">
            <img src="{{ asset('/frontend2/assets/img/details-3.png') }}" class="img-fluid" alt="">
          </div>
          <div class="col-md-8 pt-5" data-aos="fade-up">
            ...
            <p>
              Pembelajaran dimulai dari ide-ide yang siswa miliki, misalnya di keluarga, rumah, lingkungan dll.
            </p>
            <p>
        ...
        <div class="row content">
          <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
            <img src="{{ asset('/frontend2/assets/img/details-4.png') }}" class="img-fluid" alt="">
          </div>
          <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
            <h3>Akselerasi</h3>
            <p class="fst-italic">
            ...
            <ul>
              <li><i class="bi bi-check"></i> Setiap peningkatan dalam capaian belajar harus terukur.</li>
              <li><i class="bi bi-check"></i> Tes dan Ukur (TDU) menggagalkan sedini mungkin dan mengoptimalkan belajar siswa.</li>
        ...
        <div class="row g-0" data-aos="fade-left">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="100">
              <a href="{{ asset('/frontend2/assets/img/gallery/gallery-9.jpg') }}" class="gallery-lightbox">
                <img src="{{ asset('/frontend2/assets/img/gallery/gallery-9.jpg') }}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="150">
              <a href="{{ asset('/frontend2/assets/img/gallery/gallery-10.jpg') }}" class="gallery-lightbox">
                <img src="{{ asset('/frontend2/assets/img/gallery/gallery-10.jpg') }}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="200">
              <a href="{{ asset('/frontend2/assets/img/gallery/gallery-11.jpg') }}" class="gallery-lightbox">
                <img src="{{ asset('/frontend2/assets/img/gallery/gallery-11.jpg') }}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="250">
              <a href="{{ asset('/frontend2/assets/img/gallery/gallery-12.jpg') }}" class="gallery-lightbox">
                <img src="{{ asset('/frontend2/assets/img/gallery/gallery-12.jpg') }}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="300">
              <a href="{{ asset('/frontend2/assets/img/gallery/gallery-13.jpg') }}" class="gallery-lightbox">
                <img src="{{ asset('/frontend2/assets/img/gallery/gallery-13.jpg') }}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="350">
              <a href="{{ asset('/frontend2/assets/img/gallery/gallery-14.jpg') }}" class="gallery-lightbox">
                <img src="{{ asset('/frontend2/assets/img/gallery/gallery-14.jpg') }}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="400">
              <a href="{{ asset('/frontend2/assets/img/gallery/gallery-15.jpg') }}" class="gallery-lightbox">
                <img src="{{ asset('/frontend2/assets/img/gallery/gallery-15.jpg') }}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="450">
              <a href="{{ asset('/frontend2/assets/img/gallery/gallery-16.jpg') }}" class="gallery-lightbox">
                <img src="{{ asset('/frontend2/assets/img/gallery/gallery-16.jpg') }}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{ asset('/frontend2/assets/img/testimonials/testimonials-1.jpg') }}" class="testimonial-img" alt="">
                <h3>Bpk. Yance</h3>
                <h4>Tokoh Masyarakat &amp; Kepala Dinas Tata Kota</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  Sekolah ini sudah kondusif. Mari orang tua bawa anak-anaknya bersekolah.
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{ asset('/frontend2/assets/img/testimonials/testimonials-2.jpg') }}" class="testimonial-img" alt="">
                <h3>Sara Wilsson</h3>
                <h4>Designer</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{ asset('/frontend2/assets/img/testimonials/testimonials-3.jpg') }}" class="testimonial-img" alt="">
                <h3>Jena Karlis</h3>
                <h4>Store Owner</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{ asset('/frontend2/assets/img/testimonials/testimonials-4.jpg') }}" class="testimonial-img" alt="">
                <h3>Matt Brandon</h3>
                <h4>Freelancer</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{ asset('/frontend2/assets/img/testimonials/testimonials-5.jpg') }}" class="testimonial-img" alt="">
                <h3>John Larson</h3>
                <h4>Entrepreneur</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
        ...
        <div class="row" data-aos="fade-left">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="100">
              <div class="pic"><img src="{{ asset('/frontend2/assets/img/team/team-1.jpg') }}" class="img-fluid" alt=""></div>
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
            <div class="member" data-aos="zoom-in" data-aos-delay="200">
              <div class="pic"><img src="{{ asset('/frontend2/assets/img/team/team-2.jpg') }}" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Sarah Jhonson</h4>
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
            <div class="member" data-aos="zoom-in" data-aos-delay="300">
              <div class="pic"><img src="{{ asset('/frontend2/assets/img/team/team-3.jpg') }}" class="img-fluid" alt=""></div>
              <div class="member-info">
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
            <div class="member" data-aos="zoom-in" data-aos-delay="400">
              <div class="pic"><img src="{{ asset('/frontend2/assets/img/team/team-4.jpg') }}" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Amanda Jepson</h4>
