...
class Siswa extends Model
{
    ...
    function avatar($real_size = false)
    {
        ...
        if ($this->avatar && file_exists(public_path('images/siswa/' . $thumbnail . $this->avatar)))
            return asset('images/siswa/' . $thumbnail  . $this->avatar);
        else
    ...
    {
        return $this->belongsToMany(Rombel::class, 'rombel_siswa', 'siswa_id', 'rombel_id')->withPivot(['nama_depan', 'nama_belakang', 'tahunpelajaran_id'])->withTimeStamps();
    }
