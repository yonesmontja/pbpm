...
class SiswaController extends Controller
{
    ...
    public function testprofile($id, Request $request)
    {
        ...
        $rombel_awal = DB::table('rombel_siswa')->where('siswa_id', $id)->where('tahunpelajaran_id', '=', $thn_id)->get();
        //dd($rombel_awal);
        ...
        $nilai = Nilai::where(
            ...
            '=',
            $id
        )->where('tahunpel_id', '=', $thn_id)->get();
        $data_nilai = Nilai::where('siswa_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->get();
        ...
        //dd($id1);
        $mapel1 = Nilai::where('siswa_id', $id)->pluck('mapel_id')->where('tahunpel_id', '=', $thn_id)->count();
        $islam_average = Nilai::where('siswa_id', $id)->where('mapel_id', 1)->where('tahunpel_id', '=', $thn_id)->pluck('nilai')->avg();
        $protestan_average = Nilai::where('siswa_id', $id)->where('mapel_id', 2)->where('tahunpel_id', '=', $thn_id)->pluck('nilai')->avg();
        $katolik_average = Nilai::where('siswa_id', $id)->where('mapel_id', 3)->where('tahunpel_id', '=', $thn_id)->pluck('nilai')->avg();
        $ppkn_average = Nilai::where('siswa_id', $id)->where('mapel_id', 4)->where('tahunpel_id', '=', $thn_id)->pluck('nilai')->avg();
        $indonesia_average = Nilai::where('siswa_id', $id)->where('mapel_id', 5)->where('tahunpel_id', '=', $thn_id)->pluck('nilai')->avg();
        $matematika_average = Nilai::where('siswa_id', $id)->where('mapel_id', 6)->where('tahunpel_id', '=', $thn_id)->pluck('nilai')->avg();
        $ipa_average = Nilai::where('siswa_id', $id)->where('mapel_id', 7)->where('tahunpel_id', '=', $thn_id)->pluck('nilai')->avg();
        $ips_average = Nilai::where('siswa_id', $id)->where('mapel_id', 8)->where('tahunpel_id', '=', $thn_id)->pluck('nilai')->avg();
        $pjok_average = Nilai::where('siswa_id', $id)->where('mapel_id', 9)->where('tahunpel_id', '=', $thn_id)->pluck('nilai')->avg();
        $sbk_average = Nilai::where('siswa_id', $id)->where('mapel_id', 10)->where('tahunpel_id', '=', $thn_id)->pluck('nilai')->avg();
    ...
    public function cetak_PDF($id)
    {
        ...
        // ---------------------------------------------
        if ($rombel == $rombel1->id) {
            if ($rombel1->kelas_id == 1 || $rombel1->kelas_id == 2) {
            ...
            if ($rombel1->kelas_id == 3 || $rombel1->kelas_id == 4 || $rombel1->kelas_id == 5 || $rombel1->kelas_id == 6) {
                $jumlah_raport_pengetahuan = $raport_pengetahuan_agama
                    + $raport_pengetahuan_ppkn
                    + $raport_pengetahuan_indonesia
                    + $raport_pengetahuan_matematika
        ...
        if ($students->agama == "Islam" || $students->agama == "islam") {
            if (
                array_sum($nilai_keterampilan_islam) > 0
            ) {
    ...
    public function cetak_raport($id)
    {
        ...
        if (array_sum($nilai_tugas_matematika) > 0) {
            ...
            array_sum($nilai_tugas_matematika) == 0
        ) {
            $rata_rata_tugas_matematika = 0.00;
        }

        if (
            array_sum($nilai_tugas_ipa) > 0
        ) {
            for ($key = 0; $key < count($nilai_tugas_ipa); $key++) {
                if ($nilai_tugas_ipa[$key] > 0) {
                    $nilai_tugas_ipa_yes[] = $nilai_tugas_ipa[$key];
        ...
        if (array_sum($nilai_latihan_mulok) > 0) {
            ...
            array_sum($nilai_latihan_mulok) == 0
        ) {
            $rata_rata_latihan_mulok = 0.00;
        }
        ...
        if (
            ...
            if (array_sum($nilai_uh_protestan) > 0) {
                ...
                array_sum($nilai_uh_protestan) == 0
            ) {
                $rata_rata_uh_protestan = 0.00;
            }
        }
        ...
        if (array_sum($nilai_uh_matematika) > 0) {
            ...
            array_sum($nilai_uh_matematika) == 0
        ) {
            $rata_rata_uh_matematika = 0.00;
        }
        ...
        if (array_sum($nilai_pts_indonesia) > 0) {
            ...
            array_sum($nilai_pts_indonesia) == 0
        ) {
            $rata_rata_pts_indonesia = 0.00;
        }
        //dd($rata_rata_pts_indonesia);
        ...
        if (array_sum($nilai_pas_indonesia) > 0) {
            ...
            array_sum($nilai_pas_indonesia) == 0
        ) {
            $rata_rata_pas_indonesia = 0.00;
        }
        //dd($rata_rata_pas_indonesia);
        ...
        if ($raport_pengetahuan_ipa < $kkm) {
            ...
            $raport_pengetahuan_ipa >= $kkm && $raport_pengetahuan_ipa <= ($kkm + 1 * ((100 - $kkm) / 3))
        ) {
            $predikat_huruf_ipa1 = "cukup";
            $predikat_huruf_ipa = "C";
            $predikat_deskripsi_ipa = " dalam | " . implode(", ", $predikat_pengetahuan_ipa);
        ...
        if ($raport_pengetahuan_ips < $kkm) {
            ...
            $raport_pengetahuan_ips >= $kkm && $raport_pengetahuan_ips <= ($kkm + 1 * ((100 - $kkm) / 3))
        ) {
            $predikat_huruf_ips1 = "cukup";
            $predikat_huruf_ips = "C";
            $predikat_deskripsi_ips = " dalam | " . implode(", ", $predikat_pengetahuan_ips);
        ...
        if ($raport_pengetahuan_sbk < $kkm) {
            ...
            $raport_pengetahuan_sbk >= $kkm && $raport_pengetahuan_sbk <= ($kkm + 1 * ((100 - $kkm) / 3))
        ) {
            $predikat_huruf_sbk1 = "cukup";
            $predikat_huruf_sbk = "C";
            $predikat_deskripsi_sbk = " dalam | " . implode(", ", $predikat_pengetahuan_sbk);
        ...
        //dd("jumlah elemen array: " . array_sum($nilai_keterampilan_indonesia));
        if (
            array_sum($nilai_keterampilan_indonesia) > 0
        ) {
            for ($key = 0; $key < count($nilai_keterampilan_indonesia); $key++) {
                if ($nilai_keterampilan_indonesia[$key] > 0) {
                    $nilai_keterampilan_indonesia_yes[] = $nilai_keterampilan_indonesia[$key];
        ...
        if (array_sum($nilai_keterampilan_ipa) > 0) {
            ...
            array_sum($nilai_keterampilan_ipa) == 0
        ) {
            $rata_rata_keterampilan_ipa = 0.00;
        }
        ...
        if (array_sum($nilai_keterampilan_ips) > 0) {
            ...
            array_sum($nilai_keterampilan_ips) == 0
        ) {
            $rata_rata_keterampilan_ips = 0.00;
        }
        ...
        if (array_sum($nilai_keterampilan_sbk) > 0) {
            ...
            array_sum($nilai_keterampilan_sbk) == 0
        ) {
            $rata_rata_keterampilan_sbk = 0.00;
        }
        ...
        if ($raport_keterampilan_agama < $kkm) {
            ...
            $raport_keterampilan_agama >= $kkm && $raport_keterampilan_agama <= ($kkm + 1 * ((100 - $kkm) / 3))
        ) {
            $predikathuruf = "cukup";
            $predikat_keterampilan_huruf_agama = "C";
            $predikat_keterampilan_deskripsi_agama = " dalam | " . implode($predikat_keterampilan);
        ...
        if ($raport_keterampilan_matematika < $kkm) {
            ...
            $raport_keterampilan_matematika >= $kkm && $raport_keterampilan_matematika <= ($kkm + 1 * ((100 - $kkm) / 3))
        ) {
            $predikathuruf_math = "cukup";
            $predikat_keterampilan_huruf_matematika = "C";
            $predikat_keterampilan_deskripsi_matematika = " dalam | " . implode(", ", $predikat_keterampilan_math);
        ...
        if ($raport_keterampilan_mulok < $kkm) {
            ...
            $raport_keterampilan_mulok >= $kkm && $raport_keterampilan_mulok <= ($kkm + 1 * ((100 - $kkm) / 3))
        ) {
            $predikathuruf_mulok = "cukup";
            $predikat_keterampilan_huruf_mulok = "C";
            $predikat_keterampilan_deskripsi_mulok = " dalam | " . implode($predikat_keterampilan_mulok);
