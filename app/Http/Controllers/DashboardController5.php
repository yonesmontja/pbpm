...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        for($h=0; $h< count($siswa_1); $h++)
        {
            ...
            $rata_pemetaan_awal[$i] = number_format((float)(
                $indonesia_pemetaan_awal+
                $matematika_pemetaan_awal)/2, 1, '.', '');
...
// ---------------------------------
        ...
        $underlow_pemetaan_total = $underlow_pemetaan_6 + $underlow_pemetaan_5 + $underlow_pemetaan_4 + $underlow_pemetaan_3 + $underlow_pemetaan_2 + $underlow_pemetaan_1;
        $low_pemetaan_total = $low_pemetaan_6 + $low_pemetaan_5 + $low_pemetaan_4 + $low_pemetaan_3 + $low_pemetaan_2 + $low_pemetaan_1;
        $pass_pemetaan_total = $pass_pemetaan_6 + $pass_pemetaan_5 + $pass_pemetaan_4 + $pass_pemetaan_3 + $pass_pemetaan_2 + $pass_pemetaan_1;
        $high_pemetaan_total = $high_pemetaan_6 + $high_pemetaan_5 + $high_pemetaan_4 + $high_pemetaan_3 + $high_pemetaan_2 + $high_pemetaan_1;
        ...
        return view('dashboards.index',[
            ...
            'underlow_pemetaan_total' => $underlow_pemetaan_total,
            'low_pemetaan_total' => $low_pemetaan_total,
            'pass_pemetaan_total' => $pass_pemetaan_total,
            'high_pemetaan_total' => $high_pemetaan_total,
