...
class GuruController extends Controller
{
    ...
    public function profile($id)
    {
        ...
        $wali_kelas = Rombel::where('tahunpelajaran_id', '=', $thn_id)->where('guru_id', $id)->pluck('rombel')->first();
        //id dari guru yang menjadi wali kelas dari rombel ini
        $rombel = Rombel::where('tahunpelajaran_id', '=', $thn_id)->where('guru_id', $id)->pluck('id')->first();
        //hitung jumlah siswa dari rombel ini
        $murid_wali = DB::table('rombel_siswa')->where('tahunpelajaran_id', '=', $thn_id)->where('rombel_id', $rombel)->count();
        // menghitung jumlah mapel yang diampu oleh guru. Berdasarkan nilai yang sudah masuk.
        $jml_mapel_guru = Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->pluck('guru_id', 'mapel_id')->count();
        $nama_mapel_guru = Nilai::where('guru_id', '=', $id)->pluck('guru_id', 'mapel_id')->toArray();
        //dd($nama_mapel_guru);
        $penilaian1 = Penilaian::find($id);

        $jml_kelas_penilaian = Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('rombel_id', '=', 1)->pluck('guru_id', 'rombel_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('rombel_id', '=', 2)->pluck('guru_id', 'rombel_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('rombel_id', '=', 3)->pluck('guru_id', 'rombel_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('rombel_id', '=', 4)->pluck('guru_id', 'rombel_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('rombel_id', '=', 5)->pluck('guru_id', 'rombel_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('rombel_id', '=', 6)->pluck('guru_id', 'rombel_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('rombel_id', '=', 7)->pluck('guru_id', 'rombel_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('rombel_id', '=', 8)->pluck('guru_id', 'rombel_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('rombel_id', '=', 9)->pluck('guru_id', 'rombel_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('rombel_id', '=', 10)->pluck('guru_id', 'rombel_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('rombel_id', '=', 11)->pluck('guru_id', 'rombel_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('rombel_id', '=', 12)->pluck('guru_id', 'rombel_id')->count();
        //dd(Nilai::where('guru_id','=',$id)->where('rombel_id','=',1)->pluck('guru_id','rombel_id')->count());
        $jml_mapel_penilaian = Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('penilaian_id', '=', 1)->pluck('penilaian_id', 'guru_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('penilaian_id', '=', 2)->pluck('penilaian_id', 'guru_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('penilaian_id', '=', 3)->pluck('penilaian_id', 'guru_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('penilaian_id', '=', 4)->pluck('penilaian_id', 'guru_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('penilaian_id', '=', 5)->pluck('penilaian_id', 'guru_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('penilaian_id', '=', 6)->pluck('penilaian_id', 'guru_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('penilaian_id', '=', 18)->pluck('penilaian_id', 'guru_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('penilaian_id', '=', 19)->pluck('penilaian_id', 'guru_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('penilaian_id', '=', 20)->pluck('penilaian_id', 'guru_id')->count() +
            Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->where('penilaian_id', '=', 21)->pluck('penilaian_id', 'guru_id')->count();
        $jml_siswa_penilaian = Nilai::where('guru_id', '=', $id)->where('tahunpel_id', '=', $thn_id)->select('siswa_id', 'penilaian_id')->pluck('penilaian_id', 'siswa_id')->count();


        //hitung nilai rata-rata kelas untuk semua mapel
        $rata_kelas1 = Nilai::where('tahunpel_id', '=', $thn_id)->where('penilaian_id', '=', $id)->pluck('nilai')->avg();
        $rata_kelas = number_format((float)$rata_kelas1, 1, '.', '');
        //-----------------------------------------------

        $nilai = Nilai::where('tahunpel_id', '=', $thn_id)->where('guru_id', '=', $id);
        $nilai1 = Nilai::where('tahunpel_id', '=', $thn_id)->where('guru_id', '=', $id)->where('penilaian_id', '=', 6)->avg('nilai');
        //dd($nilai1);
        //$user = User::all();
